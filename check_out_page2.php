              ...
              <tbody>
               ...
               /* $query = mysqli_query($connect, "SELECT `dish_name`, `name`, `table_no`, `order_Quantity`, `currentDate`, `status`, `order_id`, `time`, 
                 ...
                 */
                 ...
                 $query = mysqli_query($connect, "SELECT `dish_name`, `name`, `table_no`, `order_Quantity`, `currentDate`, `status`, `order_id`, `time`, 
                `charges`, `invoice_status`, `email` FROM `food_order` WHERE name='$name'  AND currentDate='$cn_date' 
                and invoice_status='No Invoice generated' and customer_id='$id'");
