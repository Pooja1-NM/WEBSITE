...
<html>
 ...
 <section class="section contact-section" id="next">
      <div class="container">
           <center><h1 class="heading mb-3">Ready to join us? Fill in your details to register.</h1></center>
        <div class="row">
          <div class="col-md-3" data-aos="fade-up" data-aos-delay="100"></div>
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            
            <form action="food_order_register1.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="phone">Phone No.</label>
				...
				<div class="col-md-6 form-group">
                  ...
                  <input type="password" id="phone" class="form-control " name="Cpassword">
                </div>
				
				 
                <div class="col-md-12 form-group">
                  <label for="message" class="text-black font-weight-bold" >Address</label>
                  <textarea name="address" id="message" name="message" class="form-control" cols="30" rows="6"></textarea>
                </div>
              </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                 <center> <input type="submit" value="Register" class="btn btn-primary text-white py-3
