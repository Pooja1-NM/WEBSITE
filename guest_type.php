 ...
 <section class="section contact-section" id="next">
            ...
            <form action="food_order_login.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="name">Phone Number</label>
    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                 <center> <input type="submit" value="Order Food" class="btn btn-primary text-white py-3
...
<center><p>Don't have an account? <a href="food_order_register.php"   class="text-uppercase letter-spacing-1"> <b>
