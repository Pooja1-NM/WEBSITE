...
<html>
  ...
  <body>
    ...
    <section class="site-hero inner-page overlay" style="background-image: url(images/cor7.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            ...
            <ul class="custom-breadcrumbs mb-4">
              ...
              <li>&bullet;</li>
              <li>Aetheria Service Apartment</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-10">
            ...
            <p data-aos="fade-up" data-aos-delay="100">At Aetheria Service Apartment, explore each of our unique spaces and discover what they have to offer. Browse our collection of rooms to find the perfect retreat that matches your style and needs.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-2">
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="penthouse.html" class="room">
              <figure class="img-wrap">
              ...
              <div class="p-3 text-center room-info">
                ...
                <span class="text-uppercase letter-spacing-1"> &#8377; 6000 / per night</span><br>
				  <button  class="btn btn-primary" style="color: white;">Explore Room</button>
