...
$queryy_new =mysqli_query($connect,"SELECT `villa_booking_id` FROM `bookings_villa`
...
<strong>Booking Id :</strong> $villa_booking_id </p>
        ...
        <td style='text-align: right;'>
            <p>
            <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AETHERIA LAKE FRONT COTTAGE </strong>
...
<strong>Room Type :</strong> $room_type Room<br><br>
<strong>Room1 :</strong> $team Adults
       ...
       <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Room Charges:</strong> Rs. $charges<br><br>
...
$to_address = $email;
$subject1 = 'Booking Confirmation at Aetheria Lake Front Cottage';
...
try {
    ...
    $mail->Password = 'cdcd frjb tvwt ugmg';    // Use an App Password if 2-Step Verification is on
...
$mail->addAttachment($pdfFilePath, 'Booking_Confirmation.pdf'); // File path and name
    ...
    $mail->Body = "
        Dear $C_name,<br><br>
        Thank you for choosing Aetheria Lake Front Cottage for your stay! We are delighted to welcome you.<br><br>
        Your booking has been confirmed as follows:<br>
        <b>Check-in Date:</b> $from_date<br>
        <b>Check-out Date:</b> $to_date<br><br>
        We hope you enjoy a relaxing and memorable stay with us by the lake. Should you need any assistance or have specific requests, 
        please feel free to reach out to us.<br><br>
        Thank you once again, and we look forward to hosting you!<br><br>
        Warm regards,<br>
        Sachin M S<br>
        Aetheria Lake Front Cottage<br>
        7019454382
    ";
