...
$booked_rooms = [];
$query1 = mysqli_query($connect, "SELECT `room_id` FROM `bookings_apartments` WHERE  
...
$query = "SELECT `booking_category`, `sub_category`, `charges`, `id`, `capacity` FROM `sub_category_price` 
          WHERE booking_category='AETHERIA SERVICE APARTMENTS' 
...
$query = "SELECT `booking_category`, `sub_category`, `charges`, `id`, `capacity` 
          ...
          WHERE booking_category='AETHERIA SERVICE APARTMENTS'  AND room_type='$room_type' ";
            ...
            if ($available_rooms > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- Booking Form -->
                        <form action="book_apartments_customers2.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
                            <div class="row">
