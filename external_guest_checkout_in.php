...
include 'connection.php';
 ...
 $email = $_GET['email'];
 $villa_booking_id = $_GET['villa_booking_id'];
 $cn_date = $_GET['cn_date'];

?>
    <section class="section bg-light">
        <form class="md-float-material" method=get action="food_order_inhouse1.php" enctype="multipart/form-data">			  
...
`charges`,`invoice_status`,`email` FROM `food_order` WHERE  email='$email' and invoice_status='No Invoice generated' and customer_id='$villa_booking_id' and guest_type='Internal Guest' ");
