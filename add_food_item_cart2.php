                  ...
                  <!-- Hover effect table starts -->
					...
					<div class="col-md-12">
						...
						<div class="card-header">
								<h5 class="card-header-text">AVA`S CAFE </h5>
							</div>
							<div class="card-block">
						
						
			<form  method="post" action="add_food_item_cart.php">
            
         <div class="form-group row">
                              <label for="InputSmall" class="col-md-2 form-control-label">ENTER YOUR NAME</label>
                              <div class="col-md-6"><input type="text" class="form-control form-control-sm" id="InputSmall" 
							  name="name" placeholder="YOUR NAME" required="required"></div>
                           </div>
...
<div class="col-lg-4 multiselect-native-select">
    ...
    ?>
						...
						<center><button type="submit" class="btn btn-primary  waves-effect"> Submit</button></center>						
                      </form>
					</div>
         ...
         <div class="form-group row">
                              <label for="InputSmall" class="col-md-2 form-control-label">to address</label>
                              <div class="col-md-6"><input type="text" class="form-control form-control-sm"  
							  name="to_address" placeholder="YOUR NAME" required="required"></div>
                           </div>
			  
			  
		 <div class="form-group row">
                              <label for="InputSmall" class="col-md-2 form-control-label">subject</label>
                              <div class="col-md-6"><input type="text" class="form-control form-control-sm" id="InputSmall" 
							  name="subject" placeholder="YOUR NAME" required="required"></div>
                           </div>
			  
		
						<center><button type="submit" class="btn btn-primary  waves-effect"> send email</button></center>						
                      </form>
					</div>
