 ...
 <section class="section contact-section" id="next">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="otp_generate2.php" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="name">Email</label>
                  <input type="email" id="email" value="<?php echo $email ?>" class="form-control" name="email" required>
                </div>
               <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="name">Enter OTP</label>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="adults" class="font-weight-bold text-black">SELECT TABLE NUMBER</label>
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                    <select class="form-control" id="example-single" name="table_name" required>
    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                 <center> <input type="submit" value="SUBMIT" class="btn btn-primary text-white py-3
...
<center><p>Don't have an account? <a href="order_food_from_register.php"   class="text-uppercase letter-spacing-1"> <b>
    
Sign up Now</b></a></p></center>
