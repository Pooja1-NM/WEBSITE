...
<head>
    ...
    <title>Complete Reservation | Aetheria Hospitality</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Complete your reservation at Aetheria Hospitality. Fill in your details to confirm your booking." />
    <meta name="keywords" content="reservation, booking, Aetheria Hospitality, Chikmagalur" />
    ...
    <style>
        ...
        * {
        ...
        .reservation-hero {
            height: 50vh;
            min-height: 400px;
            background: linear-gradient(rgba(23, 35, 47, 0.85), rgba(23, 35, 47, 0.7)), url('images/hero_4.jpg');
...
<body>
    ...
    <section class="reservation-hero">
        <div class="container">
            <div class="reservation-hero-content" data-aos="fade-up">
                ...
                <p class="lead mb-4">Just a few details needed to confirm your stay with us</p>
            </div>
        </div>
    </section>
    ...
    $booked_rooms_string = !empty($booked_rooms) ? implode(',', $booked_rooms) : '0';
        ...
        <div class="container">
            ...
            <div class="reservation-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="booking-details-card">
                    <div class="booking-details-header">
                        ...
                        <?php if($available_rooms > 0): ?>
                            <span class="badge bg-success" style="background: var(--secondary-color)!important; padding: 8px 16px; border-radius: 20px;color: white;">
                ...
                <?php if($available_rooms > 0): ?>
                    ...
                    <!-- Reservation Form -->
                    <form action="book_villa_customers2.php" method="post" class="reservation-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="special-requests" name="special_requests" class="form-control" rows="3" placeholder="Any special requests or requirements..."></textarea>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    ...
                    <p class="mt-3">Experience luxury and tranquility at our premium service apartments and lakefront cottages in beautiful Chikmagalur.</p>
