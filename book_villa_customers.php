            ...
            <a href="#" class="room">
              ...
              <div class="p-3 text-center room-info">
                ...
                <span class="text-uppercase letter-spacing-1"><?php echo  " \u{20B9}"; ?> 1200 / per night</span><br>
				 ...
				 <form action="book_villa_Customer_side.php" method="post">
            ...
            <a href="#" class="room">
             ...
             <button type="submit" class="btn btn-primary">Book Now</button>
              <input type="hidden" name="room_id" value="<?php echo $room_id; ?>">
                              ...
                              <input type="hidden" name="to_date" value="<?php echo $to_date; ?>">
                              <input type="hidden" name="team" value="<?php echo $team; ?>">
                              <input type="hidden" name="room_type" value="Delux">
                               </form>
            ...
            <a href="#" class="room">
             ...
             <button type="submit" class="btn btn-primary">Book Now</button>
              <input type="hidden" name="room_id" value="<?php echo $room_id; ?>">
                              ...
                              <input type="hidden" name="to_date" value="<?php echo $to_date; ?>">
                              <input type="hidden" name="team" value="<?php echo $team; ?>">
                              <input type="hidden" name="room_type" value="plantation_view">
                               </form>
