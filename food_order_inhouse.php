...
<html>
 ...
 <section class="section contact-section" id="next">
      <div class="container">
           <center><h1 class="heading mb-3">Enter Your Details</h1></center>
        ...
        <div class="row">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <?php
include("connection.php");  // Include connection once at the top

$today = date('Y-m-d');
?>
<form action="food_order_inhouse1.php" method="get" class="bg-white p-md-5 p-4 mb-5 border">

  <div class="row">
    <div class="col-md-12 form-group">
      <label for="email" class="font-weight-bold text-black">SELECT YOUR BOOKING ID</label>
      <div class="field-icon-wrap">
        <div class="icon"><span class="ion-ios-arrow-down"></span></div>
        <select class="form-control" id="example-single-email" name="villa_booking_id">
          <option value="">SELECT YOUR BOOKING ID</option>
          <?php
          if ($connect) {
            $queryy = "SELECT `villa_booking_id`, `room_id`, `C_name`, `phone`, `email` FROM `bookings_villa` WHERE status='CHECK IN' and ? BETWEEN `from_date` AND `to_date`";
            ...
            if ($resultt) {
              while ($roww = mysqli_fetch_array($resultt)) {
                  $name=$roww['C_name'];
                  $villa_booking_id=$roww['villa_booking_id'];
                  
                echo "<option value='" . htmlspecialchars($roww['villa_booking_id']) . "'>" . htmlspecialchars($roww['villa_booking_id']) . "</option>";
              }
            } else {
  ...
  <input type='hidden' name='cn_date' value="<?php echo htmlspecialchars($today); ?>">

  <div class="row">
    <div class="col-md-12 form-group">
      <label for="table" class="font-weight-bold text-black">SELECT TABLE NUMBER</label>
      <div class="field-icon-wrap">
        <div class="icon"><span class="ion-ios-arrow-down"></span></div>
        <select class="form-control" id="example-single-table" name="table_name">
  ...
  <div class="row">
    ...
    <div class="col-md-6 form-group text-center">
      <input type="submit" value="Order Food" class="btn btn-primary text-white py-3 px-5 font-weight-bold">
    </div>
  </div>
