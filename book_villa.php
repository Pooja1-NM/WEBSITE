      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">CHOOSE ROOM CATEGORY</h1>
            <ul class="custom-breadcrumbs mb-4">
              <li><a href="index.html">Home</a></li>
              <li>&bullet;</li>
              <li>Aetheria Lake Front Cottage</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-10">
            ...
            <p data-aos="fade-up" data-aos-delay="100">At Aetheria Lake Front Cottage, explore each of our unique spaces and discover what they have to offer. Browse our collection of rooms to find the perfect retreat that matches your style and needs.</p>
          </div>
        </div>
        <div class="row">
             <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="family_room.html" class="room">
              <figure class="img-wrap">
                <img src="images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Family Room</h2>
                <span class="text-uppercase" style="color: black;">Room Capacity - 4</span><br>
				 
                <span class="text-uppercase letter-spacing-1"><?php echo  " \u{20B9}"; ?>1200 / per night</span><br>
				 <button  class="btn btn-primary" style="color: white;">Explore Room</button>
              </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="couple_room.html" class="room">
              <figure class="img-wrap">
                <img src="images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2> Delux Room</h2>
                 <span class="text-uppercase" style="color: black;">Room Capacity - 2</span><br>
               
                <span class="text-uppercase letter-spacing-1"><?php echo  " \u{20B9}"; ?>2000 / per night</span><br>
				 <button  class="btn btn-primary" style="color: white;">Explore Room</button>
              </div>
            </a>
          </div>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="dormantory.html" class="room">
              <figure class="img-wrap">
                <img src="images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Plantation View Cottage</h2>
                <span class="text-uppercase" style="color: black;">Room Capacity - 2</span><br>
				
                <span class="text-uppercase letter-spacing-1"><?php echo  " \u{20B9}"; ?> 2500 / per night</span><br>
               <button  class="btn btn-primary" style="color: white;">Explore Room</button>
              </div>
            </a>
          </div>
      ...
      <div class="container">
        <div class="row mb-4">
          <div class="col-md-3 mb-5">
            ...
            <li><a href="https://www.aetheriahospitality.com/AETHERIA_HOSPITALITY_software/">Login</a></li>
            </ul>
          </div>
          <!--div class="col-md-3 mb-5">
            <ul class="list-unstyled link">
